        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <form method="POST" action="/edituser">
                ...
                <div class="mb-4">
                    ...
                    <select class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" input type="text" name="status" placeholder="status" value="{{$users['status']}}">
                        <option>Pilot Rider</option>
                        <option>Rider Leader</option>
                    </select>
                </div>
