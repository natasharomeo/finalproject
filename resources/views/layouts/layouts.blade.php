            ...
            <div class="sidebar bg-gray-100 text-blue-100 w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
              ...
              <nav>
                ...
                <a href="#" class="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200 lg hover:text-gray-900 border-b border-gray-800 py-4">
                  <p class="ml-1 text-md font-medium tracking-wide truncate text-gray-900 font-sans">Charlene Brodely</p>
                  <div class="badge">
                    <span class="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-blue-800 bg-blue-100 rounded-full">Admin</span>
                  </div>
              </a>
              
                <a href="#" class="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200  hover:text-gray-900 border-b border-gray-500 py-4">
