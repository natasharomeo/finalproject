...
<div class="flex justify-evenly">
            ...
            <div class="">
                ...
                <div class="bg-white p-3 shadow-md rounded-lg">
                    ...
                    <ul class="list-inside space-y-2">
                                ...
                                <li><button id="buttonmodal" class="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">Join ride</button></li>
                    </ul>
                </div>
    ...
    <div class="bg-white w-1/8 h-1/4 p-12"> 
        ...
        <!-- Test content -->
        <p>
            Are you sure you want to join this ride event?
        </p>
