...
<td>
    ...
    @endforeach
        <tbody>
            ...
            <tr class="border-b hover:bg-orange-100 bg-gray-100">
                ...
                <td class="p-3 px-5"><input type="text" value="{{$user['dob']}}" class="bg-transparent"></td>
  ...
  @endforeach
        ...
        <div>
            <a href="" button type="button"class="border border-gray-200 bg-gray-200 text-gray-700 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-gray-300 focus:outline-none focus:shadow-outline"> Add </button> </a>
        </div>
    </div>
