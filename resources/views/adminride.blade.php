...
<div class="justify-center p-32">
        ...
        <div>
            <button type="button"class="border border-gray-200 bg-gray-200 text-gray-700 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-gray-300 focus:outline-none focus:shadow-outline"><a  href="/addride"> Add </a></button>
        </div>
    </div>
